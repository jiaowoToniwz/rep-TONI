...
<div class="title">
      ...
      <img class="thumb" data-original="images/excerpt.jpg" src="images/excerpt.jpg" alt=""></a>
        <header>
        ...
        <p class="meta">
          ...
          <i class="glyphicon glyphicon-eye-open"></i> 
          	共${a.readcnt }人围观</span> <a class="comment" href="article.html#comment"><i class="glyphicon glyphicon-comment"></i> 0个不明物体</a></p>
